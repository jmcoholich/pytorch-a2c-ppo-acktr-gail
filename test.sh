...
for i in {1..2}
do
    python main.py --env-name "BipedalWalker-v3" --algo ppo --use-gae --log-interval 1 --num-steps 300 --num-processes 10 --lr 1e-3 --entropy-coef 0 --value-loss-coef 0.5 --ppo-epoch 10 --num-mini-batch 1 --gamma 0.99 --gae-lambda 0.95 --num-env-steps 1000000  --use-proper-time-limits --seed $i --wandb-run-name walker_default4
done
